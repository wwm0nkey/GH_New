    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*((clamp(lerp( _VertexColorRedAffectOutlineWitdh_var, (_VertexColorRedAffectOutlineWitdh_var*node_2746), _OutlineWidthAffectedByViewDistance ),0.0,2000.0)*0.01)*_OutlineWidthControl_var.r),1) );
                #ifdef ENABLE_OPO
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(lerp( 1.0, _Texture_var.a, _EnableTextureTransparent ) - 0.5);
                float3 lightColor = _LightColor0.rgb;
                float node_6587 = 0.0;
