...
Shader "RealToon/Version 5/Tessellation/Default" {
    Properties {
        ...
        [MaterialToggle] _AlphaBaseCutout ("Alpha Base Cutout", Float ) = 0
        ...
        _SelfShadowThreshold ("Threshold", Range(0, 1)) = 0.56
        ...
        [MaterialToggle] _DirectionalLightAffectShadow ("Directional Light Affect Shadow", Float ) = 0
		...
		_ReduceShadowSpotDirectionalLight ("Reduce Shadow (Spot & Directional Light)", float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_8530_ang = node_2892.g;
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*((clamp(lerp( _VertexColorRedAffectOutlineWitdh_var, (_VertexColorRedAffectOutlineWitdh_var*node_1229), _OutlineWidthAffectedByViewDistance ),0.0,2000.0)*0.01)*_OutlineWidthControl_var.r*lerp(1.0,node_1283,_NoisyOutlineIntensity)),1) );
				#ifdef ENABLE_OPO
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half4 _Texture_var = tex2Dlod(_Texture,float4(TRANSFORM_TEX(_TexturePatternStyle_var, _Texture),0.0,_ReduceTextureQuality));
                half4 _SecondaryCutout_var = tex2D(_SecondaryCutout,TRANSFORM_TEX(i.uv0, _SecondaryCutout));
                clip(N_F_CO( lerp( (lerp((_Texture_var.r*_SecondaryCutout_var.r),_SecondaryCutout_var.r,_UseSecondaryCutout)+lerp(0.5,(-1.0),_Cutout)), saturate(( (1.0 - _Cutout) > 0.5 ? (1.0-(1.0-2.0*((1.0 - _Cutout)-0.5))*(1.0-lerp((_Texture_var.a*_SecondaryCutout_var.r),_SecondaryCutout_var.a,_UseSecondaryCutout))) : (2.0*(1.0 - _Cutout)*lerp((_Texture_var.a*_SecondaryCutout_var.r),_SecondaryCutout_var.a,_UseSecondaryCutout)) )), _AlphaBaseCutout ) , lerp( 1.0, _Texture_var.a, _EnableTextureTransparent ) ) - 0.5);
                float3 lightColor = _LightColor0.rgb;
                float node_6587 = 0.0;
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half3 node_7946 = (_Texture_var.rgb*_MainColor.rgb);
                float node_3622 = 0.0;
				float node_6794 = 1.0;
                ...
                float node_2183 = 0.2;
                float node_8383 = 0.3;
                half3 node_2871 = AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_6794,node_6794,node_6794),lerp( (node_3134*_GIShadeThreshold), float3(smoothstep( float2(node_2183,node_2183), float2(node_8383,node_8383), (node_3134.rb*_GIShadeThreshold) ),0.0), _GIFlatShade )) );
                half3 node_7891 = lerp(node_2871,(node_2871+_LightColor0.rgb+_DirectionalLightIntensity),_DirectionalLightAffectShadow);
                half4 _MaskSelfLit_var = tex2D(_MaskSelfLit,TRANSFORM_TEX(i.uv0, _MaskSelfLit));
                float3 emissive = (node_7946*N_F_SL( lerp(node_7891,lerp(node_7891,((_SelfLitColor.rgb*node_7946*lerp( 1.0, node_7946, _SelfLitHighContrast ))*_SelfLitPower),_MaskSelfLit_var.r),_SelfLitIntensity) , node_7891 ));
                ...
                half3 node_2687 = N_F_GLO( lerp(node_2779,lerp(node_2779,(_GlossColor.rgb*_GlossColorPower),N_F_GLOT( _GlossTexture_var.r , smoothstep( 0.1, lerp(0.1,1.0,_GlossSoftness), pow(max(0,dot(halfDirection,normalDirection)),exp2(lerp(-2,15,_Glossiness))) ) )),_MaskGloss_var.r) , node_2779 );
                float node_4353 = 0.0;
                float node_3687 = 0.0;
                half3 node_4858 = lerp(float3(node_4353,node_4353,node_4353),(lerp( _RimLightColor.rgb, lerp(float3(node_3687,node_3687,node_3687),_RimLightColor.rgb,_LightColor0.rgb), _LightAffectRimLightColor )*_RimLightColorPower),smoothstep( 1.72, lerp(1.72,0.29,_RimLightSoftness), pow(1.0-max(0,dot(normalDirection, viewDirection)),(1.0 - _RimLightUnfill)) ));
                float node_4736 = 1.0;
                ...
                half3 node_2388 = (node_7946*lerp((((_SelfShadowRealTimeShadowColor.rgb*_SelfShadowRealTimeShadowColorPower)*node_7102*node_9600*node_8910)*saturate(node_6613.b)),(N_F_RL_1( lerp(node_2687,(node_2687+node_4858),_RimLightInLight) , node_2687 )*N_F_ST( lerp(((_ShadowTColor.rgb*_ShadowTColorPower)*node_9600*node_8910*node_7102),float3(node_4736,node_4736,node_4736),smoothstep( lerp(0.0,0.22,_ShadowTHardness), 0.22, ((_ShadowT_var.r*(1.0 - _ShadowTShadowThreshold))*(lerp( node_573, (attenuation*node_573), _LightFalloffAffectShadowT )*_ShadowTLightThreshold)) )) )*N_F_SON_1( lerp( 1.0, node_5206, _ShowNormal ) )*_LightColor0.rgb),N_F_SS( (smoothstep( lerp(0.3,0.899,_SelfShadowHardness), 0.9, (node_573*lerp(2.8,lerp( _SelfShadowThreshold, (_SelfShadowThreshold*(1.0 - i.vertexColor.g)), _VertexColorGreenControlSelfShadowThreshold ),_SelfShadowThreshold)) )*attenuation) , attenuation )));
                half3 node_5435 = (node_2388*lerp(1.0,0.3,_DirectionalLightAffectShadow));
                ...
                half3 node_2704 = N_F_R( lerp(node_5435,lerp(node_2388,N_F_FR( lerp( node_9694, _FReflection_var.rgb, _UseFReflection ) , node_9694 ),_MaskReflection_var.r),_ReflectionIntensity) , node_5435 );
                half3 node_7395 = N_F_SL_1( lerp(node_2704,lerp(node_2704,node_7946,_MaskSelfLit_var.r),_SelfLitIntensity) , node_2704 );
                float3 finalColor = emissive + N_F_RL( lerp((node_7395+node_4858),node_7395,_RimLightInLight) , node_7395 );
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half3 node_3134 = N_F_SON( node_5206 , normalDirection );
                half node_573 = 0.5*dot(lerp( N_F_CLD( lerp(lightDirection,lerp( _CustomLightDirection.rgb, mul( unity_ObjectToWorld, float4(_CustomLightDirection.rgb,0) ).xyz.rgb, _CustomLightDirectionFollowObjectRotation ),_CustomLightDirectionIntensity) , lightDirection ), viewDirection, _SelfShadowShadowTAtViewDirection ),node_3134)+0.5;
                half3 node_2388 = (node_7946*lerp((((_SelfShadowRealTimeShadowColor.rgb*_SelfShadowRealTimeShadowColorPower)*node_7102*node_9600*node_8910)*saturate(node_6613.b)),(N_F_RL_1( lerp(node_2687,(node_2687+node_4858),_RimLightInLight) , node_2687 )*N_F_ST( lerp(((_ShadowTColor.rgb*_ShadowTColorPower)*node_9600*node_8910*node_7102),float3(node_4736,node_4736,node_4736),smoothstep( lerp(0.0,0.22,_ShadowTHardness), 0.22, ((_ShadowT_var.r*(1.0 - _ShadowTShadowThreshold))*(lerp( node_573, (lightfos*node_573), _LightFalloffAffectShadowT )*_ShadowTLightThreshold)) )) )*N_F_SON_1( lerp( 1.0, node_5206, _ShowNormal ) )*_LightColor0.rgb),N_F_SS( (smoothstep( lerp(0.3,0.899,_SelfShadowHardness), 0.9, (node_573*lerp(2.8,lerp( _SelfShadowThreshold, (_SelfShadowThreshold*(1.0 - i.vertexColor.g)), _VertexColorGreenControlSelfShadowThreshold ),_SelfShadowThreshold)) )*attenuation) , attenuation ))*lightfos);
                half3 node_5435 = (node_2388*lerp(1.0,0.3,_DirectionalLightAffectShadow));
                float3 node_9694 = Ref( viewReflectDirection , _ReflectionRoughtness );
                half2 node_8431 = reflect(viewDirection,normalDirection).rg;
                half2 node_4207 = (float2(node_8431.r,(-1*node_8431.g))*0.5+0.5);
                half4 _FReflection_var = tex2Dlod(_FReflection,float4(TRANSFORM_TEX(node_4207, _FReflection),0.0,_ReflectionRoughtness));
                half4 _MaskReflection_var = tex2D(_MaskReflection,TRANSFORM_TEX(i.uv0, _MaskReflection));
                half3 node_2704 = N_F_R( lerp(node_5435,lerp(node_2388,N_F_FR( lerp( node_9694, _FReflection_var.rgb, _UseFReflection ) , node_9694 ),_MaskReflection_var.r)*lightfos,_ReflectionIntensity) , node_5435 );
                half4 _MaskSelfLit_var = tex2D(_MaskSelfLit,TRANSFORM_TEX(i.uv0, _MaskSelfLit));
                half3 node_7395 = N_F_SL_1( lerp(node_2704,lerp(node_2704,node_7946,_MaskSelfLit_var.r),_SelfLitIntensity) , node_2704 );
                float3 finalColor = N_F_RL( lerp((node_7395+node_4858)*lightfos,node_7395,_RimLightInLight) , node_7395 );
