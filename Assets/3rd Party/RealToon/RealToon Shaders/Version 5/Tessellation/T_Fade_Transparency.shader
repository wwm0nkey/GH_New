    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half node_7861 = lerp((_Texture_var.a*_MaskTransparency_var.r),_Texture_var.a,_Opacity);
                clip(saturate(( lerp( 1.0, 0.74, _AffectShadow ) > 0.5 ? (1.0-(1.0-2.0*(lerp( 1.0, 0.74, _AffectShadow )-0.5))*(1.0-node_7861)) : (2.0*lerp( 1.0, 0.74, _AffectShadow )*node_7861) )) - 0.5);
                ...
                float node_2183 = 0.2;
                float node_8383 = 0.3;
                half3 node_2871 = AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_5898,node_5898,node_5898),lerp( (node_3134*_GIShadeThreshold), float3(smoothstep( float2(node_2183,node_2183), float2(node_8383,node_8383), (node_3134.rb*_GIShadeThreshold) ),0.0), _GIFlatShade )) );
