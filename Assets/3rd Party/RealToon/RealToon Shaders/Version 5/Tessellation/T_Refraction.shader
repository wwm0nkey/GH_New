    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_3924 = lerp(node_7067,lerp(node_7067,lerp( _Texture_var.rgb, (_Texture_var.rgb*_MainColor.rgb), _MainColorAffectTexture ),_Texture_var.a),_TextureIntesnity);
                float node_3622 = 0.0;
				float node_4432 = 1.0;
                ...
                float node_2183 = 0.2;
                float node_8383 = 0.3;
                half3 node_2871 = AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_4432,node_4432,node_4432),lerp( (node_3134*_GIShadeThreshold), float3(smoothstep( float2(node_2183,node_2183), float2(node_8383,node_8383), (node_3134.rb*_GIShadeThreshold) ),0.0), _GIFlatShade )) );
                ...
                float3 emissive = (node_3924*N_F_SL( lerp(node_7891,lerp(node_7891,((_SelfLitColor.rgb*node_3924*lerp( 1.0, node_3924, _SelfLitHighContrast ))*_SelfLitPower),_MaskSelfLit_var.r),_SelfLitIntensity) , node_7891 ));
                ...
                float node_7145 = 0.0;
                float3 finalColor = emissive + N_F_D( (node_1225+lerp((_DepthColor.rgb*_DepthColorPower),float3(node_7145,node_7145,node_7145),smoothstep( clamp(_DepthEdgeHardness,_DepthEdgeHardness,(1.0-0.001)), 1.0, saturate((sceneZ-partZ)/_Depth) ))) , node_1225 );
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_7145 = 0.0;
                float3 finalColor = N_F_D( (node_1225+lerp((_DepthColor.rgb*_DepthColorPower),float3(node_7145,node_7145,node_7145),smoothstep( clamp(_DepthEdgeHardness,_DepthEdgeHardness,(1.0-0.001)), 1.0, saturate((sceneZ-partZ)/_Depth) ))) , node_1225 );
