...
public class RealToonShaderGUI : ShaderGUI
{
    ...
    bool ShowLighting;
    bool ShowReflection;
    bool ShowFReflection;
    bool ShowRimLight;
    bool ShowDepth;
    bool ShowSeeThrough;
    bool ShowDisableEnable;
    ...
    MaterialProperty _DirectionalLightAffectShadow;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        _Texture = ShaderGUI.FindProperty("_Texture", properties);
        ...
        _DirectionalLightAffectShadow = ShaderGUI.FindProperty("_DirectionalLightAffectShadow", properties);
        ...
        EditorGUILayout.LabelField("RealToon 5.0.0", EditorStyles.boldLabel);
        ...
        if (ShowTextureColor)
        {
            ...
            if (shader_name == "default_d" || shader_name == "tessellation_d" || shader_name == "default_ft" || shader_name == "tessellation_ft")
            {
                ...
                materialEditor.ShaderProperty(_Texture, _Texture.displayName);

                EditorGUI.BeginDisabledGroup(_Texture.textureValue == null);
        ...
        if (ShowLighting)
        {
            ...
            materialEditor.ShaderProperty(_DirectionalLightAffectShadow, _DirectionalLightAffectShadow.displayName);
            EditorGUI.BeginDisabledGroup(_DirectionalLightAffectShadow.floatValue == 0);
        ...
        if (ShowDisableEnable)
        {
            ...
            Rect r_ref = EditorGUILayout.BeginVertical("HelpBox");
            materialEditor.ShaderProperty(_N_F_R, _N_F_R.displayName);
            EditorGUILayout.EndVertical();

            Rect r_fref = EditorGUILayout.BeginVertical("HelpBox");
